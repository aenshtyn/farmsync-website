          ...
          <div className="grid grid-cols-1 gap-12 md:grid-cols-2">
            <div className="flex flex-col justify-center">
              ...
              <p className="mb-8 text-lg md:text-xl">
                FarmSync revolutionizes how farms operate with integrated
                technology solutions for dairy management and feed formulation.
              </p>
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-md transition-all hover:shadow-lg">
              ...
              <p className="mb-4 text-gray-600">
                A complete farm management system that integrates all your
                agricultural operations into one platform.
              </p>
              <Link
            ...
            <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-md transition-all hover:shadow-lg">
              ...
              <p className="mb-4 text-gray-600">
                Specialized tools for dairy farms to track production, animal
                health, breeding, and financial performance.
              </p>
              <Link
                href="/products/dairy"
                className="text-blue-600 hover:text-blue-800"
            ...
            <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-md transition-all hover:shadow-lg">
              ...
              <p className="mb-4 text-gray-600">
                Advanced feed formulation tools to optimize animal nutrition
                while minimizing costs.
              </p>
              <Link
                href="https://formulator.farmsync.co.ke"
                className="text-blue-600 hover:text-blue-800"
                target="_blank"
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Streamline operations and reduce manual work with automated
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Optimize resource usage and identify cost-saving
                    opportunities in your operations.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Make informed decisions based on real-time data and
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Reduce time spent on administrative tasks and focus on
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mx-auto max-w-3xl rounded-lg bg-green-50 p-8 shadow-lg">
            ...
            <p className="mb-6 text-center text-lg font-medium text-gray-700">
              &quot;FarmSync has completely transformed how we manage our dairy
              farm. The milk production tracking alone has helped us increase
              our yield by 15%, and we have reduced feed costs by optimizing our
              formulations. &quot;
            </p>
      ...
      <section className="w-full bg-green-700 py-16 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="mx-auto mb-8 max-w-2xl text-lg">
            Join hundreds of Kenyan farmers who are already benefiting from
            FarmSyncs innovative farm management solutions.
          </p>
