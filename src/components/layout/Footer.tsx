        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <p className="mb-4 text-gray-300">
              Modern farm management solutions tailored for Kenyan agriculture.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/products/platform" className="text-gray-300 hover:text-white">
                  FarmSync Platform
                </Link>
              </li>
              <li>
                <Link href="/products/dairy" className="text-gray-300 hover:text-white">
                  Dairy Management
                </Link>
              </li>
              <li>
                <Link href="/products/formulator" className="text-gray-300 hover:text-white">
                  Feed Formulation
                </Link>
              </li>
            </ul>
